...
while True:
    ...
    if category in categories:
        options = random.sample((categories[category]), len(categories[category])) # Cuarta modificación.
        break
    else: 
...
for word in options: #Juego todas las palabras de la categoría elegida.
